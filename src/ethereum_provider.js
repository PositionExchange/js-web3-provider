...
class PosiWeb3Provider extends BaseProvider {
  constructor(config) {
    super(config);
    ...
    switch (payload.method) {
      ...
      default:
        throw new ProviderRpcError(
          4200,
          `Posi does not support calling ${payload.method} synchronously without a callback. Please provide a callback parameter to call ${payload.method} asynchronously.`
        );
    }
    return response;
  }
    ...
    return new Promise((resolve, reject) => {
      ...
      switch (payload.method) {
        ...
        case "eth_subscribe":
          throw new ProviderRpcError(
            4200,
            `Posi does not support calling ${payload.method}. Please use your own solution`
          );
        default:
          // call upstream rpc
