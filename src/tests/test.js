...
const posiwallet = window.posiwallet;
...
describe("PosiWeb3Provider constructor tests", () => {
  ...
  test("test Ethereum setAddress", () => {
    const provider = new posiwallet.Provider({
      ethereum: {
        chainId: 1,
        rpcUrl: "",
        isMetaMask: false,
  ...
  test("test setConfig", (done) => {
    const provider = new posiwallet.Provider({ ethereum: ropsten });
    const web3 = new Web3(provider);
  ...
  test("test eth_chainId", (done) => {
    const provider = new posiwallet.Provider({ ethereum: bsc });
    const web3 = new Web3(provider);
  ...
  test("test eth_accounts", (done) => {
    const provider = new posiwallet.Provider({ ethereum: mainnet });
    const web3 = new Web3(provider);
  ...
  test("test eth_sign", (done) => {
    ...
    posiwallet.postMessage = (message) => {
